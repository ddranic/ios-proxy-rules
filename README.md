...
*   **YouTube GEOSITE** `https://cdn.jsdelivr.net/gh/ddranic/ios-proxy-rules@main/geosite/shadowrocket/youtube.list`
*   **China GEOIP:** `https://cdn.jsdelivr.net/gh/ddranic/ios-proxy-rules@main/geoip/shadowrocket/cn.list`
